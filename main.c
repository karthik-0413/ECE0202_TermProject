...
// **************************************************************************************************************
// WE WERE UNABLE TO FIGURE OUT HOW TO DISPLAY THE STATUS OF THE ELEVATOR TO TERA TERM, SO WE COMMENETED IT OUT *
// **************************************************************************************************************

// ***************************************************************
// ALL OF THE MESSAGES DISPLAY PROPERLY EXCEPT FOR "MOVING DOWN" *
// ***************************************************************

/*
void SysTick_Handler(void);
void SystemCoreClockConfigure(void);
void teratermm (int number);
...
// Member Function that helps print the status of the elevator
void teratermm (int number)
{
  stdout_init();

	// Switch case that determines which message will be printed out
	switch(number)
	{
		case 1:
			printf ("Moving Up\n\r");
